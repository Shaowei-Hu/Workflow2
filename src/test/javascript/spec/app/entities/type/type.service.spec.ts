    ...
    describe('Type Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Type', () => {
                service.create(new Type(null)).subscribe(received => {
            ...
            it('should update a Type', () => {
                service.update(new Type(123)).subscribe(received => {
