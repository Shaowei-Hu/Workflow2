...
describe('Service Tests', () => {
    describe('Trader Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TraderService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/traders';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Trader', () => {
                service.create(new Trader(null)).subscribe(received => {
            ...
            it('should update a Trader', () => {
                service.update(new Trader(123)).subscribe(received => {
