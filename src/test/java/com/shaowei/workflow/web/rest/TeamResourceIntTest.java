...
import com.shaowei.workflow.service.TeamService;
import com.shaowei.workflow.service.dto.TeamDTO;
import com.shaowei.workflow.service.mapper.TeamMapper;
...
public class TeamResourceIntTest {
    ...
    public void getAllTeamsWithEagerRelationshipsIsEnabled() throws Exception {
        TeamResource teamResource = new TeamResource(teamServiceMock);
