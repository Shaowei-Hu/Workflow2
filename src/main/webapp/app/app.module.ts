...
import { Workflow2CoreModule } from 'app/core';
import { Workflow2AppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        BrowserModule,
        Workflow2AppRoutingModule,
        Ng2Webstorage.forRoot({ prefix: 'jhi', separator: '-' }),
        Workflow2SharedModule,
        Workflow2CoreModule,
        Workflow2HomeModule,
...
export class Workflow2AppModule {}
